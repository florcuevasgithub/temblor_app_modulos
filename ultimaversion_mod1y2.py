# -*- coding: utf-8 -*-
"""UltimaVersion-mod1y2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14ir_TBRqRf4vKCFjb0nP1Mk1SHPgrWA1
"""
...
if opcion == "1️⃣ Análisis de una medición":
    ...
    if st.button("Comparar Mediciones"):
        ...
        if not archivos_cargados:
            ...
            df_config1_meta = pd.read_csv(config1_archivos["Reposo"])
            df_config2_meta = pd.read_csv(config2_archivos["Reposo"])
